...
if build_end_idx == -1:
    build_end_idx = content.find('//', build_start_idx)

if build_start_idx != -1 and build_end_idx != -1:
...
# also remove the 'widget.isOnline' references in the rest of the file? Wait, _ConversationTile had widget.isOnline removed since we dropped the avatar entirely from the sub-tile.
